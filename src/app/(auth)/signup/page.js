      ...
      <div className="flex-1 flex flex-col justify-start pt-12 px-4 sm:px-6 lg:px-20 xl:px-24">
        <div className="mx-auto w-full max-w-sm lg:w-96">
          ...
          <form className="space-y-5" onSubmit={handleSubmit(onSubmit)}>
            ...
            >
              {loading ? (<><div className="animate-spin rounded-full h-4 w-4 border-b-2 border-white mr-2" />Creating Account...</>) : "Create Iris Monde Workspace"}
            </button>

            <p className="text-center text-xs text-[var(--color-muted)] font-medium">
              Already have an account?{" "}
              <Link href="/login" className="font-black text-[var(--color-primary)] hover:text-[var(--color-primary-hover)]">Sign in to your Iris Monde Workspace</Link>
            </p>
